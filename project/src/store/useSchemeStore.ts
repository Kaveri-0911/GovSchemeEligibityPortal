...
const mockSchemes: Scheme[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/2933243/pexels-photo-2933243.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  ...
  },
  {
    ...
    eligibilityCriteria: {
      income: { max: 500000 },
      other: ['Must be listed in SECC database', 'No existing health insurance']
    },
    benefits: [
  ...
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/7107213/pexels-photo-7107213.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  ...
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/50987/money-card-business-credit-card-50987.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  ...
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/3769981/pexels-photo-3769981.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  ...
  },
  {
    ...
    applicationLink: 'https://scholarships.gov.in',
    imageUrl: 'https://images.pexels.com/photos/5212665/pexels-photo-5212665.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
  ...
  },
  {
    ...
    eligibilityCriteria: {
      age: { min: 18, max: 40 },
      other: ['Bank account holder', 'Not covered under any statutory social security scheme']
    },
    benefits: [
    ...
    imageUrl: 'https://images.pexels.com/photos/7876429/pexels-photo-7876429.jpeg',
...
const useSchemeStore = create<SchemeState>((set, get) => ({
  ...
  fetchSchemes: async () => {
    ...
    try {
      ...
      set({ schemes: mockSchemes, filteredSchemes: mockSchemes, loading: false });
    } catch (error) {
  ...
  filterSchemes: (category, query, filters) => {
    ...
    if (filters) {
      if (filters.ministry) {
        filtered = filtered.filter(scheme => scheme.ministry === filters.ministry);
      }
